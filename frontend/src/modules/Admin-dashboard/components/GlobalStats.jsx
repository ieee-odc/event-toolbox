...
export default function GlobalStats() {
    const { events, totalWorkshops, totalParticipants, currentParticipants, totalOrganizers } = useSelector((state) => state.statsStore);
                    ...
                    <div className="row gy-4 gy-sm-1">
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="d-flex justify-content-between align-items-start border-end pb-3 pb-sm-0 card-widget-3">
                                <div>
                                    <h3 className="mb-1">{totalOrganizers}</h3>
                                    <p className="mb-0">Active Organizers</p>
                                </div>
                                <div className="avatar me-sm-4">
                                    <span className="avatar-initial rounded bg-label-secondary">
