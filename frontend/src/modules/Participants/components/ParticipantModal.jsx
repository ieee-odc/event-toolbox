...
import { addParticipant, resetParticipantModal, toggleParticipantModal, updateSelectedParticipantField } from "../../../core/Features/Participants";
...
function ParticipantModal() {
  ...
  return (
    <>
          {isParticipantModalOpen && <div className="modal-backdrop fade show"></div>}
